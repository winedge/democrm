...
use App\Console\Commands\ModuleMailableTemplateMakeCommand;
use Nwidart\Modules\Activators\FileActivator;
use Nwidart\Modules\Commands as ModuleCommands;
use Nwidart\Modules\Providers\ConsoleServiceProvider;

return [
    /*
    |--------------------------------------------------------------------------
    | Show Modules in Settings
    |--------------------------------------------------------------------------
    |
    | This option controls whether the Modules menu item is shown in the settings page
    |
    */
    'show_in_settings' => env('SHOW_MODULES_IN_SETTINGS', false),
    ...
    */
    ...
    'stubs' => [
        ...
        'files' => [
            'bootstrap/module' => 'bootstrap/module.php',
    ...
    'paths' => [
        ...
        */
        'generator' => [
            // Custom
            'mailable-template' => ['path' => 'app/Mail', 'generate' => false],
    ...
    */
    'commands' => ConsoleServiceProvider::defaultCommands()
        ->merge([
            ModuleMailableTemplateMakeCommand::class,
        ])->filter(function (string $command) {
            return ! in_array($command, [
                ModuleCommands\ComposerUpdateCommand::class,
                ModuleCommands\Actions\CheckLangCommand::class,
                ModuleCommands\LaravelModulesV6Migrator::class,
                ModuleCommands\Publish\PublishTranslationCommand::class,
                ModuleCommands\Publish\PublishCommand::class,
                ModuleCommands\Publish\PublishConfigurationCommand::class,
            ]);
        })->toArray(),
