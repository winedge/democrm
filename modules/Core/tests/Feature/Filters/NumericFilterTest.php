...
class NumericFilterTest extends TestCase
{
    ...
    public function test_numeric_filter_rule_with_equal_operator(): void
    {
    ...
    public function test_numeric_filter_rule_with_not_equal_operator(): void
    {
        Event::factory()->count(2)->state(new Sequence(
            ['total_guests' => 1],
            ['total_guests' => 2]
    ...
    public function test_numeric_filter_rule_with_less_operator(): void
    {
    ...
    public function test_numeric_filter_rule_with_less_or_equal_operator(): void
    {
    ...
    public function test_numeric_filter_rule_with_greater_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['total_guests' => 20],
            ['total_guests' => 80],
    ...
    public function test_numeric_filter_rule_with_greater_or_equal_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['total_guests' => 20],
            ['total_guests' => 80],
    ...
    public function test_numeric_filter_rule_with_between_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['total_guests' => 20],
            ['total_guests' => 30],
    ...
    public function test_numeric_filter_rule_with_not_between_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['total_guests' => 20],
            ['total_guests' => 30],
    ...
    public function test_numeric_filter_rule_with_is_null_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['date' => null],
            ['date' => date('Y-m-d')],
    ...
    public function test_numeric_filter_rule_with_is_not_null_operator(): void
    {
        Event::factory()->count(3)->state(new Sequence(
            ['date' => null],
            ['date' => null],
